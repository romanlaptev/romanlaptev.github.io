...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<footer class="entry-meta">
		<a class="entry-format" href="<?php echo esc_url( get_post_format_link( 'image' ) ); ?>" title="<?php echo esc_attr( sprintf( __( 'All %s posts', 'truly_minimal' ), get_post_format_string( 'image' ) ) ); ?>"><?php echo get_post_format_string( 'image' ); ?></a>
		<span class="sep"> / </span>
