...
def find (fs_path,html_path,spc):
  ...
  print "<tr><td colspan=\"5\">",html_path,"</td></tr>"
...
# проверить, есть ли совпадения маски поиска с именем файла
          ...
          if s1.count(s2) > 0:
              ...
              print "<td align=left>"
              print "<li><a href=" + server_root + "/cgi-bin/" + name_script + "?action=annotation&filename=" + fs_path + "/" + file +"> create annotation  </a></li>"
              print "<li><a href=" + server_root + "/cgi-bin/" + name_script + "?action=bookmark&filename=" + fs_path + "/" + file +"> add in bookmarks         </a></li>"
              print "<li><a href=" + server_root + "/cgi-bin/" + name_script + "?action=edit&filename=" + fs_path + "/" + file +"> edit file         </a></li>"
              print "<li><a href=" + server_root + "/cgi-bin/" + name_script + "?action=move&filename=" + fs_path + "/" + file +"> move to trash   </a></li>"
              print "<li><a href=" + server_root + "/cgi-bin/" + name_script + "?action=delete&filename=" + fs_path + "/" + file +"> delete file  </a></li>"
              print "<li><a href=" + server_root + "/cgi-bin/" + name_script + "?action=rename&filename=" + fs_path + "/" + file +"> rename file         </a></li>"
...
# Сформировать индексную страницу, начиная с текущего каталога
   ...
   print "<table border=0 cellpadding=1 cellspacing=1 width=95% align=center>"
   ...
   print "<td class=broun2 width=20%><b> action </b></td>"
   print "</tr>"
...
if action == "rename":
   ...
   print "<input type=hidden name=oldfile value=",filename,">"
   print "<input type=text size=30 name=newfile value=",filename,">"
