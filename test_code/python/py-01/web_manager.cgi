...
#--------------------------------------------------------
   ...
   print "     </td>"
   print "     <td class=cm1 align=center>\n"
   print "         <input type=text size=30 name=fs_path_desc value="+ fs_root + dir_path + ">"
   print "    </td>"
   print "   </tr>\n"
   print "</table>\n"
...
#   print "<option value=rename> rename file          </option>"
...
#       print "song = ", song, "<br>"
    ...
    print "<a href=" + s1 + "?action=delete&filename=" + song + "> delete file  </a> "
