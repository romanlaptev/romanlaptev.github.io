...
<head>
	...
	<link rel="stylesheet" type="text/css" href="//cdnjs.cloudflare.com/ajax/libs/foundation/6.1.2/foundation.min.css">
...
<div class="row">
	<h2>включение в JSP страницу статичного файла</h2>
<pre>
