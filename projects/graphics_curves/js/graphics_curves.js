...
//=======================================		
		form_epic.onsubmit = function( event ){
console.log("submit", event);
			var context = document.querySelector("#canvas-epic").getContext("2d");
			context.fillStyle = 'green';

			var params = {
				start_x : parseInt( form_epic.start_x.value ),
				start_y : parseInt( form_epic.start_y.value ),
				step : parseFloat( form_epic.step.value ),
				num_repeat : eval( form_epic.num_repeat.value ),
				k1 : parseInt( form_epic.k1.value ),
				k2 : parseInt( form_epic.k2.value ),
				k3 : parseInt( form_epic.k3.value ),
				px : parseInt( form_epic.px.value ), // сжатие по X
				py : parseInt( form_epic.py.value ), // сжатие по Y
			};
console.log("submit", params);
