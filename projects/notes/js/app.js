...
console.log( _vars["logMsg"] );
			...
			case "load-xml-book":
				_vars["requestUrl"] = "data/export.xml";
				loadBookXml();
			break;
...
console.log( _vars["logMsg"] );
				...
				var content_links = {};
				for( var n = 0; n < _vars["xmlObj"]["content_links"][0]["childNodes"]["item"].length; n++){
					var item = _vars["xmlObj"]["content_links"][0]["childNodes"]["item"][n]["attributes"];
					var key = item["content_id"];
					var value = item["parent_id"];
					content_links[key] = value;
				}//next
				_vars["xmlObj"]["content_links"] = content_links;
				
				//convert content xml object to js object
				var content = {};
				var num_nodes = 0;
				for( var n = 0; n < _vars["xmlObj"]["content"][0]["childNodes"]["node"].length; n++){
					var xmlObj = _vars["xmlObj"]["content"][0]["childNodes"]["node"][n];
...
delete xmlObj;
				...
				if( num_nodes > 0 ){
					...
					//output main pages of book list (parent_id=0)
...
//console.log( p );
		...
		var nodes=_vars["xmlObj"]["content"];
		var content_links=_vars["xmlObj"]["content_links"];
...
//console.log(linkedHtml);
	...
	function _drawNode(node, htmlContainer){
		var listHtml = "";
		var itemHtml = _vars["templates"][ "tpl-node-list"];
