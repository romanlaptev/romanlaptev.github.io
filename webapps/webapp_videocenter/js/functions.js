...
//console.log( _headers );
	...
	//"15-Sep-2018 22:13:00";
		...
		function _convertXmlToObj_old(xml){
...
*/
		...
		function _alert( message, level ){
			switch (level) {
				case "info":
					message = "<p class='lr-alert lr-alert-info'>" + message + "</p>";
					_log(message);
				break;
				
				case "warning":
					message = "<p class='lr-alert lr-alert-warning'>" + message + "</p>";
					_log(message);
				break;
				
				case "danger":
				case "error":
					message = "<p class='lr-alert lr-alert-danger'>" + message + "</p>";
					_log(message);
				break;
				
				case "success":
					message = "<p class='lr-alert lr-alert-success'>" + message + "</p>";
					_log(message);
				break;
		...
		return{
			...
			convertXmlToObj_old: _convertXmlToObj_old,
