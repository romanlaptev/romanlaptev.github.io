...
//console.log(err);
					...
					var log = "<br>get cache element " + config["storage_key"] + ", <b>size</b>: "+ cache_size_kb.toFixed(2) +" Kbytes, "+ cache_size_mb.toFixed(2) +" Mbytes";
...
//console.log(err);
			...
			var cache_size_kb = cache_size / 1024 ;
			var cache_size_mb = cache_size_kb / 1024;
			var log = "<br>save in cache element " + config["storage_key"] + ", <b>size</b>: "+ cache_size_kb.toFixed(2) +" Kbytes, "+ cache_size_mb.toFixed(2) +" Mbytes";
			//var status = true;
			if( err !== null){
