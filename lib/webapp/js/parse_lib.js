...
//console.log( data );			
				...
				lib_obj["templates"]["node_tpl_url"] = templates.find("#view-node #book-url li")[0].outerHTML;
...
console.log(message);
			...
			//add dropbox disk link
			html_book_url += add_dropbox_links();
			html = html.replace("#book-url-links", html_book_url);
			...
			html = html.replace("#book-links", html_book_links);
			...
			html = html.replace("#book-url2", html_book_url2);
