...
//console.log( data );			
				...
				lib_obj["templates"]["block_book_category_url_tpl"] = "?q=book_nodes&nid={{nid}}&mlid={{mlid}}&plid={{plid}}";
...
console.log(html, $("#block-tags").attr("id"), $("#block-taxonomy-alpha").attr("id") );			
