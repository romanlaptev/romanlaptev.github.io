...
//fix filter href="{{url}}"				
//if( item_tpl.indexOf("%7B%7Burl%7D%7D") > 0 ){
	//item_tpl = item_tpl.replace("%7B%7Burl%7D%7D", "{{url}}")
//}
				...
				lib_obj["templates"]["taxonomy_list_item_tpl"] = templates.find("#taxonomy-menu li")[0].outerHTML;
				...
				lib_obj["templates"]["breadcrumb_item_tpl"] = templates.find("#breadcrumb-tpl").html();
...
var exec_end = new Date();
var runtime_s = (exec_end.getTime() - exec_start.getTime()) / 1000;
var message = "<br>- book.get_child_pages( params), runtime: " + runtime_s  + " sec";
info.push( message );
					break;
