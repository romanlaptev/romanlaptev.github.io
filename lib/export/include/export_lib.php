...
<fieldset><legend><b>export params</b></legend>";
	...
	$out .= "sqlite_path: <input type=text name=sqlite_path size=60 
value='sqlite:/mnt/terra/clouds/Yandex.Disk/sync/sites/romanlaptev.github.io/lib/cms/db/lib.sqlite'/><br>";
